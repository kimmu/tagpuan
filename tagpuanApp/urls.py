...
urlpatterns = [
    ...
    path('profile/postdelete/',views.postdelete, name='postdelete'),
    path('profile/lostdelete/',views.lostdelete, name='lostdelete'),
    path('profile/founddelete/',views.founddelete, name='founddelete'),

...
urlpatterns = [
    ...
    path('profile/post_details/<int:pk>/',views.Postprofile, name='Postprofile'),
    path('profile/filterlostpost/<int:pk>/',views.filterlostpost, name='filterlostpost'),
    path('profile/filterfoundpost/<int:pk>/',views.filterfoundpost, name='filterfoundpost'),
